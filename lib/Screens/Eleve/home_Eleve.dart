...
class HomeDScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _HomeEleveBody();
  }
}

class _HomeEleveBody extends StatefulWidget {
  const _HomeEleveBody();

  @override
  State<_HomeEleveBody> createState() => _HomeEleveBodyState();
}

class _HomeEleveBodyState extends State<_HomeEleveBody> {
  @override
  Widget build(BuildContext context) {
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Consultez vos cours et résultats',
                            style: TextStyle(
                              fontSize: 13,
                              color: Colors.grey,
                            ),
